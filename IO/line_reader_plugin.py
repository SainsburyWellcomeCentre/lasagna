    ...
    def showLoadDialog(self, fname=None):
        ...
        if os.path.isfile(fname):
            ...
            if len(data[0]) == 3:
                ...
                self.lasagna.addIngredient(object_name=obj_name,
                                           kind=self.kind,
                ...
                for this_index in d_series:
                    ...
                    print("Adding point series %d with %d points" % (this_index, len(tmp)))
                ...
                print(("Line series has %d columns. Only 3 or 4 columns are supported" % len(data)))
