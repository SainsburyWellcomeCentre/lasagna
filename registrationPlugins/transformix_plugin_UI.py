...
class Ui_transformix_plugin(object):
    def setupUi(self, transformix_plugin):
        ...
        self.chooseStack_pushButton.setObjectName(_fromUtf8("chooseStack_pushButton"))
        ...
        self.chooseTransform_pushButton.setObjectName(_fromUtf8("chooseTransform_pushButton"))
        ...
        self.outputDirSelect_pushButton = QtGui.QPushButton(transformix_plugin)
        ...
        self.outputDirSelect_pushButton.setObjectName(_fromUtf8("outputDirSelect_pushButton"))
    ...
    def retranslateUi(self, transformix_plugin):
        ...
        self.chooseStack_pushButton.setText(_translate("transformix_plugin", "Choose Stack", None))
        self.chooseTransform_pushButton.setText(_translate("transformix_plugin", "Choose Transform", None))
        self.outputDirSelect_pushButton.setText(_translate("transformix_plugin", "Dir", None))
