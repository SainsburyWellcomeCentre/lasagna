...
#
# Created: Thu Aug 13 12:04:58 2015
...
class Ui_lasagna_mainWindow(object):
    def setupUi(self, lasagna_mainWindow):
        ...
        self.marker_comboBox = QtGui.QComboBox(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.marker_comboBox.sizePolicy().hasHeightForWidth())
        self.marker_comboBox.setSizePolicy(sizePolicy)
        self.marker_comboBox.setMaximumSize(QtCore.QSize(85, 24))
        self.marker_comboBox.setObjectName(_fromUtf8("marker_comboBox"))
        self.horizontalLayout_4.addWidget(self.marker_comboBox)
        ...
        self.markerSize_spinBox.setProperty("value", 10)
        ...
        self.markeAlpha_spinBox = QtGui.QSpinBox(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.markeAlpha_spinBox.sizePolicy().hasHeightForWidth())
        self.markeAlpha_spinBox.setSizePolicy(sizePolicy)
        self.markeAlpha_spinBox.setMinimum(0)
        self.markeAlpha_spinBox.setMaximum(255)
        self.markeAlpha_spinBox.setProperty("value", 255)
        self.markeAlpha_spinBox.setObjectName(_fromUtf8("markeAlpha_spinBox"))
        self.horizontalLayout_9.addWidget(self.markeAlpha_spinBox)
    ...
    def retranslateUi(self, lasagna_mainWindow):
        ...
        self.checkBox.setText(_translate("lasagna_mainWindow", "Line", None))
